...
import type { NewsDocument } from '~/types/news';
import { newsZ } from '~/types/news';
...
export const loader = async ({ params, request }: LoaderFunctionArgs) => {
  ...
  const initial = await loadQuery<NewsDocument>(NEWS_QUERY, params).then(
    (res) => ({ ...res, data: res.data ? newsZ.parse(res.data) : null })
  );
