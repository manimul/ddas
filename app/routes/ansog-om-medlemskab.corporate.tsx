  ...
  return (
    <div className='grid md:grid-cols-8 gap-6 '>
      <div className=' col-span-4 space-y-4'>
        <h1 className='text-4xl '>Corporate Medlemskap</h1>
        <div className='prose font-serif dark:prose-invert lg:prose-lg  prose-a:text-cyan-600 dark:prose-a:text-cyan-200'>
          Det Danske Afrika Selskab giver mulighed for at firmaer med
          aktiviteter i Afrika, eller som har særlige interesser på kontinentet,
          kan blive optaget som Corporate Member. For medlemskabet gælder at: Op
          til fire medarbejdere fra firmaet kan deltage i hvert af selskabets
          arrangementer. Deltagelse sker på samme fordelagtige vilkår og priser
          som for selskabets øvrige medlemmer. Det årlige medlemskab er 5000 kr.
        </div>
      </div>
