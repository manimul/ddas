...
import { CITY_QUERY } from '~/sanity/queries';
import type { CityDocument } from '~/types/city';
import { cityZ } from '~/types/city';
...
export const loader = async ({ params, request }: LoaderFunctionArgs) => {
  ...
  const initial = await loadQuery<CityDocument>(CITY_QUERY, params).then(
    (res) => ({
      ...res,
      data: res.data ? cityZ.parse(res.data) : null,
    })
  );
