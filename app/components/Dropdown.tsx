...
export default function Dropdown({ items, title, setNavbar }: DropdownProps) {
  return (
    <Menu as='div' className='relative inline-block text-left'>
      <div>
        <Menu.Button className='inline-flex w-full items-center	 align justify-center gap-x-1.5 rounded-md   py-2   ring-gray-300 font-light text-gray-500 hover:text-gray-700 '>
          {title}
                ...
                {({ active }) => (
                  <NavLink
                    ...
                    className={classNames(
                      active
                        ? 'bg-gray-100 text-base text-gray-900'
