...
export function CorporateCTA() {
  return (
    <div className='mx-auto w-full py-32'>
      <div className='relative isolate overflow-hidden bg-[#F87B16] px-4 md:px-6 pt-6  shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0'>
